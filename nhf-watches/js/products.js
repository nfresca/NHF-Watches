...
var products = [
  {
    ...
    inStock: true,
    description: 'Seiko 5 Automatic Blue Dial Stainless Steel Men\'s Watch.\nEl <strong>Seiko 5 SNXS77</strong> es la prueba de que la elegancia no tiene por qué ser exclusiva. Su hipnótica esfera azul y su diseño de inspiración clásica lo convierten en una pieza camaleónica, capaz de elevar un look casual o rematar un estilo formal con absoluta naturalidad. Es, en esencia, un icono de la relojería mecánica que ofrece esa sofisticación atemporal que nunca pasa de moda, ideal para quien busca un reloj con personalidad y carácter.',
    specs: [
      { label: 'Movimiento',  value: 'Automático - Seiko Calibre 7S26' },
      { label: 'Caja',        value: '38 mm' },
      { label: 'Cristal',     value: 'Hardlex' },
      { label: 'Impermeabilidad', value: '30m' },
    ],
    badge: null,
  },
  {
    ...
    condition: 'NUEVO CON CAJA Y PAPELES',
    inStock: false,
    description: 'PRX Powermatic 80 Automatic Ice Blue Dial Men\'s Watch.\nEl <strong>PRX Powermatic 80</strong> con esfera "Ice Blue" es la unión perfecta entre la nostalgia de los años 70 y la frescura contemporánea. Su caja integrada y su brazalete de acero satinado enmarcan un dial tipo waffle en un tono azul glaciar que aporta una luminosidad única y un aire de lujo moderno a la muñeca. Es una pieza audaz pero refinada, diseñada para quienes buscan un reloj con presencia mecánica excepcional y un color que rompe con lo convencional sin perder la sofisticación.',
    specs: [
      { label: 'Movimiento',  value: 'Automático - POWERMATIC 80.111' },
      { label: 'Caja',        value: '40mm' },
      { label: 'Cristal',     value: 'Zafiro' },
      { label: 'Impermeabilidad',        value: '100m' },
    ],
    badge: null,
  },
  {
    ...
    specs: [
      { label: 'Movimiento',  value: 'Automático - Calibre 5' },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: 'Impermeabilidad',        value: '50m' },
    ],
    badge: 'Icónico',
  },
  {
